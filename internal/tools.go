...
//go:generate go run github.com/oapi-codegen/oapi-codegen/v2/cmd/oapi-codegen --config=../openapi/instance-api.oapi-codegen.models.yaml ../openapi/instance-api.yaml
